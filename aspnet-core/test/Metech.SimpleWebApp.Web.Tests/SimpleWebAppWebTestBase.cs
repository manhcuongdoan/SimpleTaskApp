...
{
    public abstract class SimpleWebAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SimpleWebAppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SimpleWebAppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SimpleWebAppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SimpleWebAppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SimpleWebAppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SimpleWebAppDbContext, Task<T>> func)
        {
            T result;
